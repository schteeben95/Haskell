...
/* package ShapeDrawing-0.3.2.0 */
#ifndef VERSION_ShapeDrawing
#define VERSION_ShapeDrawing "0.3.2.0"
#endif /* VERSION_ShapeDrawing */
#ifndef MIN_VERSION_ShapeDrawing
#define MIN_VERSION_ShapeDrawing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 2)
#endif /* MIN_VERSION_ShapeDrawing */
...
/* package codeworld-api-0.2.2.1 */
#ifndef VERSION_codeworld_api
#define VERSION_codeworld_api "0.2.2.1"
...
#define CURRENT_COMPONENT_ID "ShapeDrawing-0.3.2.0-B6DI3bcEWtDBfiJYvcES6f-WarmupInteraction"
